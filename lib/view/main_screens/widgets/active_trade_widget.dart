      ...
      child: isExtended
          ? Column(
              children: [
                ...
                SymbolRowWidget(
                  ...
                  size: widget.activeTrade!.tradeCondition.toUpperCase(),
                  isHigher:
                      widget.activeTrade!.tradeCondition.toUpperCase() == 'BUY'
                          ? true
                          : false,
                ),
                const SizedBox(height: 10),
          ...
          : Row(
              ...
              children: [
                ...
                Text(
                  widget.activeTrade!.tradeCondition.toUpperCase(),
                  style: TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.w500,
                    color: widget.activeTrade!.tradeCondition.toUpperCase() ==
                            'BUY'
                        ? Colors.green
                        : Colors.red,
                  ),
